...
export const translations = {
  en: {
    ...
    // --- Games ---
    gamesTitle: 'Games',
    gamesIntro: 'A quick break? Two players, rotating paddles, first to 5 wins.',
    pongTitle: 'Rotary Pong',
    pongHowto: 'Player 1: W / S move, A / D rotate. Player 2: ↑ / ↓ move, ← / → rotate.',
    p1Label: 'Player 1',
    p2Label: 'Player 2',
    gameWinner: 'wins!',
    gameRestart: 'Restart',
  ...
  de: {
    ...
    // --- Games ---
    gamesTitle: 'Spiele',
    gamesIntro: 'Kurze Pause? Zwei Spieler, drehbare Schläger, wer zuerst 5 Punkte hat, gewinnt.',
    pongTitle: 'Rotary Pong',
    pongHowto: 'Spieler 1: W / S bewegen, A / D drehen. Spieler 2: ↑ / ↓ bewegen, ← / → drehen.',
    p1Label: 'Spieler 1',
    p2Label: 'Spieler 2',
    gameWinner: 'gewinnt!',
